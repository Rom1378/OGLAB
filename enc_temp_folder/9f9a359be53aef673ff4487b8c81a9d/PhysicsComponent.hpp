...
protected:
	...
	void rotatePhysxBody(const PxTransform& transform);
...
public:
	...
	virtual void setPosition(const glm::vec3& worldPosition);
	virtual  void setRotationQuaternion(const glm::quat& worldRotation);
